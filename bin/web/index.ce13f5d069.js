...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      } else if ("undefined" === 'undefined' && typeof location !== 'undefined') {
        // web worker
        PACKAGE_PATH = encodeURIComponent(location.pathname.toString().substring(0, location.pathname.toString().lastIndexOf('/')) + '/');
      }
      var PACKAGE_NAME = '/Users/alex/repos/mupen64plus-web/bin/web/index.ce13f5d069.data';
      var REMOTE_PACKAGE_BASE = 'index.ce13f5d069.data';
...
Module['FS_createPath']("/", "data", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/Users/alex/repos/mupen64plus-web/bin/web/index.ce13f5d069.data');

      };
      Module['addRunDependency']('datafile_/Users/alex/repos/mupen64plus-web/bin/web/index.ce13f5d069.data');
    ...
    loadPackage({"files": [{"filename": "/data/RiceVideoLinux.ini", "start": 0, "end": 23245}, {"filename": "/data/mupen64plus.cfg", "start": 23245, "end": 39201}, {"filename": "/data/mupen64plus.ini", "start": 39201, "end": 476244}, {"filename": "/data/InputAutoCfg.ini", "start": 476244, "end": 515205}], "remote_package_size": 515205, "package_uuid": "f9c7e5fd-0ab1-47df-95bb-4d2295208dfc"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'index.ce13f5d069.wasm';
...
var ASM_CONSTS = {
  1709140: function() {const start = function() { const doStart = Module.cwrap('start', 'number', ['number'], { async: true }); const doStartPromise = new Promise(function(resolve, reject) { doStart(0).then(function() { resolve() }) .catch(function(err) { if (err === 'unwind') { resolve(); } else { console.error(err); reject(err); } }); }); Module.asyncAction = doStartPromise; return doStartPromise; }; const stop = function() { const doStop = Module.cwrap('stopEmulator', null, null); doStop(); }; const pause = function(pauseTargets) { const netplayEnabled = Module.netplayConfig && Module.netplayConfig.player !== 0; if (netplayEnabled) { const netplayPause = Module.cwrap('netplay_request_pause', null, ['number'], { async: true }); const pauseTargetBufferPtr = Module._malloc(4*4); pauseTargets.forEach(function(target, index) { Module.setValue(pauseTargetBufferPtr + (index * 4), target, 'i32'); }); if (Module.asyncAction) { return Module.asyncAction.then(() => { const pausePromise = new Promise(function(resolve, reject) { Module.netplay.pausePromiseResolve = resolve; Module.netplay.pausePromiseReject = reject; }); return netplayPause(pauseTargetBufferPtr) .then(() => { Module._free(pauseTargetBufferPtr); }) .then(() => pausePromise); }); } else { const pausePromise = new Promise(function(resolve, reject) { Module.netplay.pausePromiseResolve = resolve; Module.netplay.pausePromiseReject = reject; }); const actionPromise = netplayPause(pauseTargetBufferPtr) .then(() => { Module._free(pauseTargetBufferPtr); }).then(() => { return pausePromise; }).then((counts) => { return counts; }); Module.asyncAction = actionPromise; return actionPromise; } } else { const pauseEmulator = Module.cwrap('pauseEmulator', null, null, { async: true }); if (Module.asyncAction) { return Module.asyncAction.then(() => pauseEmulator()); } else { const asyncAction = pauseEmulator(); Module.asyncAction = asyncAction; return asyncAction; } } }; const resume = function() { const netplayEnabled = Module.netplayConfig && Module.netplayConfig.player !== 0; if (netplayEnabled) { const netplayResume = Module.cwrap('netplay_request_resume', null, null, { async: true }); if (Module.asyncAction) { Module.asyncAction.then(() => netplayResume()); } else { Module.asyncAction = netplayResume(); } } else { const resumeEmulator = Module.cwrap('resumeEmulator', null, null, { async: true }); if (Module.asyncAction) { Module.asyncAction.then(() => resumeEmulator()); } else { Module.asyncAction = resumeEmulator(); } } return Module.asyncAction; }; const forceDumpSaveFiles = function() { const doForceDumpSaveFiles = Module.cwrap('dump_save_files', null, null, { async: true }); if (Module.asyncAction) { return Module.asyncAction.then(() => doForceDumpSaveFiles()); } else { const asyncAction = doForceDumpSaveFiles(); Module.asyncAction = asyncAction; return asyncAction; } }; const _reloadRom = Module.cwrap('reloadRom', null, null, { async: true }); const reloadRom = function(romData) { Module.romData = romData; Module.SDL2.audio.scriptProcessorNode.onaudioprocess = function() {}; const p = _reloadRom().catch(function(err) { if (err === 'unwind') { return; } else { throw err; } }); if (Module.asyncAction) { Module.asyncAction.then(() => p); } else { Module.asyncAction = p; } return Module.asyncAction; }; const _getDram = Module.cwrap('getDram', 'number', null); const getDram = function() { const dramPtr = _getDram(); return new Uint8Array(Module.HEAPU8.buffer, dramPtr, 0x800000); }; const emulatorControls = {}; emulatorControls.start = start; emulatorControls.stop = stop; emulatorControls.pause = pause; emulatorControls.resume = resume; emulatorControls.forceDumpSaveFiles = forceDumpSaveFiles; emulatorControls.softReset = Module.cwrap('softReset', null, null); emulatorControls.hardReset = Module.cwrap('hardReset', null, null); emulatorControls.advanceFrame = Module.cwrap('advanceFrame', null, null); emulatorControls.reloadRom = reloadRom; emulatorControls.getDram = getDram; Module.emulatorControls = emulatorControls; return 0;},  
 1713165: function() {return Module.canvas.width;},  
 1713197: function() {return Module.canvas.height;},  
 1713230: function() {return Module.coreConfig.emuMode},  
 1713267: function() {return Module.netplayConfig.player},  
 1713306: function() {FS.mkdir('/mupen64plus'); FS.mount(IDBFS, {}, '/mupen64plus'); return 0;},  
 1713383: function() {return Module.netplayConfig.registrationId;},  
 1713431: function($0, $1) {console.error("BAiLING on alist command processing due to acmd index: ",$0|0," with pointer ",$1|0);},  
 1713534: function() {return Module.netplayConfig.registrationId;},  
 1713582: function($0) {const pauseCountsPtr = $0; const pauseCounts = []; for (let i = 0; i < 4; i++) { pauseCounts[i] = Module.getValue(pauseCountsPtr + (i * 4), 'i32'); } if (Module.netplay.pausePromiseResolve) { Module.netplay.pausePromiseResolve(pauseCounts); } return 0;},  
 1713839: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 1714064: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 1714201: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 ...
 1714918: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 1714986: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vi', $2, [$3]); }; SDL2.capture.silenceTimer = setTimeout(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); }},  
 1716638: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vi', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']);},  
 1717048: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } }},  
 1717653: function($0, $1) {var SDL2 = Module['SDL2']; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[$0 + ((j*numChannels + c) << 2) >> 2]; } }},  
 1718133: function($0) {var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearTimeout(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } SDL2.capture.stream = undefined; } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); SDL2.capture.scriptProcessorNode = undefined; } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); SDL2.capture.mediaStreamNode = undefined; } if (SDL2.capture.silenceBuffer !== undefined) { SDL2.capture.silenceBuffer = undefined } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); SDL2.audio.scriptProcessorNode = undefined; } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; }},  
 1719305: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); SDL2.data32Data = data; } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 1720784: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 1721773: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 1721866: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 1721935: function() {return window.innerWidth;},  
 1721965: function() {return window.innerHeight;}
};
function copyInputAutoConfig(){ return Asyncify.handleAsync(function() { return new Promise(function (resolve, reject) { const fileExists = FS.analyzePath('/mupen64plus/data/InputAutoCfg.ini', false).exists; if (!fileExists) { const contents = FS.readFile('/data/InputAutoCfg.ini', { encoding: 'utf8' }); const dataDirExists = FS.analyzePath('/mupen64plus/data', false).exists; if (!dataDirExists) { FS.mkdir('/mupen64plus/data'); } FS.writeFile('/mupen64plus/data/InputAutoCfg.ini', contents); FS.syncfs(false, function(err){ if (err) { reject(err); } resolve(); }); } else { resolve(); } }); }); }
function initIDBFS(){ return Asyncify.handleAsync(function() { return new Promise (function(resolve, reject) { console.log('Initiating async IDBFS read from peristent storage.'); FS.syncfs(true, function(err) { console.log('sync complete!'); if (err) { reject(err); } resolve(0); }); }); }); }
function loadRomConfigOptionOverride(configKey){ const config = UTF8ToString(configKey); const maybeRomConfigOptionOverrides = Module.romConfigOptionOverrides; if (maybeRomConfigOptionOverrides) { const maybeRiceConfigOptionOverrides = maybeRomConfigOptionOverrides.videoRice; if (maybeRiceConfigOptionOverrides) { const maybeConfigOverride = maybeRiceConfigOptionOverrides[config]; if (maybeConfigOverride != null) { return parseInt(maybeConfigOverride); } } } return -1; }
function startCore(){ return Asyncify.handleAsync(function() { return new Promise (function (resolve, reject) { console.log('Starting game core'); var doStartCore = Module.cwrap('startEmulator', 'number', ['number'], { async: true }); doStartCore(0); console.log('Finished starting game core'); resolve(0); }); }); }
function writeROM(romLocationStr){ return Asyncify.handleAsync(function() { return new Promise(function (resolve, reject) { const romLocation = UTF8ToString(romLocationStr); const path = romLocation.substr(0, romLocation.lastIndexOf('/')); const filename = romLocation.substr(romLocation.lastIndexOf('/') + 1); FS.writeFile(romLocation, new Uint8Array(Module.romData)); var contents = FS.readFile(romLocation, { encoding: 'binary' }); console.log('Written file contents: %o', contents); delete Module.romData; resolve(); }); }); }
  ...
  Module["___syscall_mkdir"] = ___syscall_mkdir;
  ...
  Module["___syscall_mknod"] = ___syscall_mknod;
  ...
  Module["_beginStats"] = _beginStats;

  function _checkForUnreliableMessages(responseBufferPointer,
                                         maxNumberOfMessages,
  ...
  Module["_checkForUnreliableMessages"] = _checkForUnreliableMessages;
  ...
  Module["__webgl_enable_WEBGL_multi_draw_instanced_base_vertex_base_instance"] = __webgl_enable_WEBGL_multi_draw_instanced_base_vertex_base_instance;
  ...
  Module["_findAutoInputConfigName"] = _findAutoInputConfigName;
  ...
  Module["_netplayInit"] = _netplayInit;
  ...
  Module["_requestFileSync"] = _requestFileSync;
  ...
  Module["_sendReliableMessage"] = _sendReliableMessage;
  ...
  Module["_sendUnreliableMessage"] = _sendUnreliableMessage;
  ...
  Module["_waitForReliableMessage"] = _waitForReliableMessage;
...
var asmLibraryArg = {
  ...
  "abort": _abort,
  "beginStats": _beginStats,
  "checkForUnreliableMessages": _checkForUnreliableMessages,
  "copyInputAutoConfig": copyInputAutoConfig,
  ...
  "fd_seek": _fd_seek,
  "fd_write": _fd_write,
  "findAutoInputConfigName": _findAutoInputConfigName,
  ...
  "loadRomConfigOptionOverride": loadRomConfigOptionOverride,
  "netplayInit": _netplayInit,
  "requestFileSync": _requestFileSync,
  "sendReliableMessage": _sendReliableMessage,
  "sendUnreliableMessage": _sendUnreliableMessage,
  "setTempRet0": _setTempRet0,
  "startCore": startCore,
  "strftime_l": _strftime_l,
  "waitForReliableMessage": _waitForReliableMessage,
  "writeROM": writeROM
};
var asm = createWasm();
/** @type {function(...*):?} */
...
var _start = Module["_start"] = function() {
  return (_start = Module["_start"] = Module["asm"]["start"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _startEmulator = Module["_startEmulator"] = function() {
  return (_startEmulator = Module["_startEmulator"] = Module["asm"]["startEmulator"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _pauseEmulator = Module["_pauseEmulator"] = function() {
  return (_pauseEmulator = Module["_pauseEmulator"] = Module["asm"]["pauseEmulator"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _resumeEmulator = Module["_resumeEmulator"] = function() {
  return (_resumeEmulator = Module["_resumeEmulator"] = Module["asm"]["resumeEmulator"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _stopEmulator = Module["_stopEmulator"] = function() {
  return (_stopEmulator = Module["_stopEmulator"] = Module["asm"]["stopEmulator"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _softReset = Module["_softReset"] = function() {
  return (_softReset = Module["_softReset"] = Module["asm"]["softReset"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _hardReset = Module["_hardReset"] = function() {
  return (_hardReset = Module["_hardReset"] = Module["asm"]["hardReset"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _advanceFrame = Module["_advanceFrame"] = function() {
  return (_advanceFrame = Module["_advanceFrame"] = Module["asm"]["advanceFrame"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _reloadRom = Module["_reloadRom"] = function() {
  return (_reloadRom = Module["_reloadRom"] = Module["asm"]["reloadRom"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _getDram = Module["_getDram"] = function() {
  return (_getDram = Module["_getDram"] = Module["asm"]["getDram"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _dump_save_files = Module["_dump_save_files"] = function() {
  return (_dump_save_files = Module["_dump_save_files"] = Module["asm"]["dump_save_files"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _netplay_request_input = Module["_netplay_request_input"] = function() {
  return (_netplay_request_input = Module["_netplay_request_input"] = Module["asm"]["netplay_request_input"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _check_valid = Module["_check_valid"] = function() {
  return (_check_valid = Module["_check_valid"] = Module["asm"]["check_valid"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _process_udp_packet = Module["_process_udp_packet"] = function() {
  return (_process_udp_packet = Module["_process_udp_packet"] = Module["asm"]["process_udp_packet"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _netplay_request_pause = Module["_netplay_request_pause"] = function() {
  return (_netplay_request_pause = Module["_netplay_request_pause"] = Module["asm"]["netplay_request_pause"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _netplay_request_resume = Module["_netplay_request_resume"] = function() {
  return (_netplay_request_resume = Module["_netplay_request_resume"] = Module["asm"]["netplay_request_resume"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var dynCall_viffffffffiff = Module["dynCall_viffffffffiff"] = function() {
  return (dynCall_viffffffffiff = Module["dynCall_viffffffffiff"] = Module["asm"]["dynCall_viffffffffiff"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var dynCall_viiiiiiff = Module["dynCall_viiiiiiff"] = function() {
  return (dynCall_viiiiiiff = Module["dynCall_viiiiiiff"] = Module["asm"]["dynCall_viiiiiiff"]).apply(null, arguments);
};
