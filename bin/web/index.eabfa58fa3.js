...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '/Users/alex/repos/mupen64plus-web/bin/web/index.eabfa58fa3.data';
      var REMOTE_PACKAGE_BASE = 'index.eabfa58fa3.data';
...
Module['FS_createPath']("/", "data", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_/Users/alex/repos/mupen64plus-web/bin/web/index.eabfa58fa3.data');

      };
      Module['addRunDependency']('datafile_/Users/alex/repos/mupen64plus-web/bin/web/index.eabfa58fa3.data');
...
var wasmBinaryFile;
  wasmBinaryFile = 'index.eabfa58fa3.wasm';
